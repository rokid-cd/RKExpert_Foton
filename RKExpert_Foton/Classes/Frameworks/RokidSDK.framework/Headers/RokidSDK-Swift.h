...
@interface RKChatDetailViewController (SWIFT_EXTENSION(RokidSDK)) <QMUIAlbumViewControllerDelegate>
...
@interface RKChatDetailViewController (SWIFT_EXTENSION(RokidSDK)) <QMUIImagePickerViewControllerDelegate>
...
@class JCConversationMessageData;
@class JCGroupData;
...
SWIFT_CLASS("_TtC8RokidSDK25RKMideaSlamViewController")
...
+ (void)deviceNewOrientation:(UIInterfaceOrientationMask)interfaceOrientation;
